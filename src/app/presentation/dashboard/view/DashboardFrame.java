...
public class DashboardFrame extends MaFrame {
    ...
    private void initComponents() {
        ...
        bookingFrame1 = new app.presentation.booking.view.BookingFrame();
        ...
        refreshButton = new app.core.components.MaButton();
    ...
    private void LogoutbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LogoutbtnActionPerformed
        ...
        dispose();
        new app.presentation.auth.view.SignInFrame().setVisible(true);
...
try {
    ...
    private app.presentation.booking.view.BookingFrame bookingFrame1;
